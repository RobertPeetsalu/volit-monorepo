...
const people = [
  { id: "lumen-42", name: "Lumen 42", initials: "L4", role: "Health & wellbeing", score: 86, followers: "1,248", color: visualColors.green },
  { id: "north-star", name: "North Star", initials: "NS", role: "Climate & energy", score: 91, followers: "2,904", color: visualColors.green },
  { id: "quiet-civic", name: "Quiet Civic", initials: "QC", role: "Housing & communities", score: 78, followers: "846", color: visualColors.gold },
];

const elections = [
  { id: "digital-rights", title: "Digital Rights Ombud", type: "Single winner", status: "Voting open", date: "Closes 28 August", candidates: 6, color: visualColors.purple },
  { id: "climate-council", title: "International Climate Council", type: "Multi-winner · 3 seats", status: "Nominations open", date: "Nominate by 2 September", candidates: 14, color: visualColors.green },
  { id: "youth-assembly", title: "Youth Assembly delegates", type: "Multi-winner · 12 seats", status: "Results published", date: "Completed 11 June", candidates: 32, color: visualColors.blue },
];
    ...
    <div className="volit-shell">
      <aside className={cn("sidebar", mobileNav && "sidebar-open")}>
        ...
        <div className="sidebar-bottom">
          <button className="profile-chip" onClick={() => notify("Your profile is identified by a wallet-scoped pseudonym.")}><Avatar initials="RA" color={visualColors.purple} size="sm" label="River Ash" /><span className="profile-chip-copy"><strong>River Ash</strong><small>Verified voter</small></span><MoreHorizontal size={16} /></button>
      ...
      <main className="main-content">
        <header className="topbar">
          ...
          <Breadcrumbs root="Estonia" current={selectedItem ? (selectedItem.type === "problem" ? "Problem" : "Project") : navItems.find((item) => item.id === activeView)?.label ?? "Overview"} />
